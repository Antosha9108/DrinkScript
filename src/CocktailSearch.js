        ...
        <div className="font-roboto">
            ...
            <button onClick={fetchCocktailData} className="bg-rose-500 text-white px-4 py-2 mb-8 rounded-r-lg border  border-rose-500 drop-shadow-lg">Search</button>
            {
                cocktailData.length > 0 && (
                    <div className=' text-slate-100 border border-gray-700 mx-10 my-8 rounded-lg bg-gray-800/70 backdrop-opacity-10 divide-y divide-gray-800/70 drop-shadow-lg'>
                        {/* Cocktail name */}
                ...
                showMore === false && cocktailData.length > 1 && (
                    <div >
                        {cocktailData.slice(1).map((cocktail) => (
                            <div key={cocktail.idDrink} className=' text-slate-100 border border-gray-700 mx-10 my-8 rounded-lg bg-gray-800/70 backdrop-opacity-10 divide-y divide-gray-800/70 drop-shadow-lg'>
                                {/* Cocktail name */}
